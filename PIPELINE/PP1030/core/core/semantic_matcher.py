...
class MatchReport:
    ...
    def get_match(self, semantic_key: str) -> MatchResult | None:
    ...
    def get_column_name(self, semantic_key: str) -> str | None:
...
class SemanticMatcher:
    ...
    def _calculate_similarity_score(self, alias: str, column: str) -> float:
        ...
        common_prefix_len = 0
        for i, (a, c) in enumerate(zip(alias, column, strict=False)):
            if a == c:
                common_prefix_len += 1
            else:
                break
