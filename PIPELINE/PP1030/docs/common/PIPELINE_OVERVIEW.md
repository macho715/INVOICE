...
## 현재 버전: v4.0.44 (Core v1.2.0)

### 최신 업데이트 (2025-12-21)
**전체 파이프라인 실행 성능**:
- 총 실행 시간: 492.11초 (약 8분 12초)
- Stage 1: 299.20초 (약 5분) - 8,930행 처리, 3개 시트
- Stage 2: 28.56초 - 57개 컬럼, 13개 파생 컬럼
- Stage 3: 106.12초 (약 1분 46초) - 12개 시트, 63개 표준 헤더
- Stage 4: 58.24초 (약 1분) - 182개 이상치 탐지

**주요 처리 통계 (2025-12-21 실행 결과)**:
- 총 데이터 행수: 8,930행
- 업데이트: 19건
- 신규 레코드: 1,737건
- SQM 계산: 8,905건 (99.7%)
- Stack_Status 파싱: 8,831건 (98.9%)
- 이상치 탐지: 182건 (ML=181, 데이터품질=1)
- 표준 헤더 정렬: 63개 (100% 매칭)
