...
class HeaderDefinition:
    ...
    def matches_any_alias(self, normalized_name: str) -> bool:
        ...
        """
        return normalized_name in [alias.lower().replace(' ', '') 
...
class HeaderRegistry:
    ...
    def _initialize_definitions(self):
        ...
        self.register(HeaderDefinition(
            ...
            aliases=[
                "Case No", "Case No.", "CASE NO", "case number", "Case Number",
        ...
        self.register(HeaderDefinition(
            ...
            category=HeaderCategory.IDENTIFICATION,
            aliases=[
                "No", "No.", "Number", "Item No", "Item Number",
                "NO", "Num", "Item_No", "ItemNo", "번호", "아이템번호"
            ],
        ...
        self.register(HeaderDefinition(
            ...
            aliases=[
                "ETD/ATD", "ETD", "ATD", "ETD_ATD", "Estimated Departure",
                "Actual Departure", "Departure Date", "Departure",
                "출발일", "ETD-ATD", "etd/atd", "ETD / ATD"
            ],
        ...
        self.register(HeaderDefinition(
            ...
            category=HeaderCategory.TEMPORAL,
            aliases=[
                "ETA/ATA", "ETA", "ATA", "ETA_ATA", "Estimated Arrival",
                "Actual Arrival", "Arrival Date", "Arrival",
                "도착일", "ETA-ATA", "eta/ata", "ETA / ATA"
            ],
        ...
        warehouse_locations = [
            ...
            ("dsv_al_markaz", "DSV Al Markaz", [
                "DSV Al Markaz", "DSV_Al_Markaz", "DSV AlMarkaz",
                "DSV Al-Markaz", "DSV Markaz", "Al Markaz"
            ]),
            ("dsv_outdoor", "DSV Outdoor", [
                "DSV Outdoor", "DSV_Outdoor", "DSV Out", "DSV실외",
                "DSV 실외", "DSV-Outdoor"
            ]),
            ("dsv_mzp", "DSV MZP", [
                "DSV MZP", "DSV_MZP", "MZP", "DSV-MZP"
            ]),
            ("jdn_mzd", "JDN MZD", [
                "JDN MZD", "JDN_MZD", "JDN-MZD", "JDN", "MZD",
                "JDN창고", "MZD창고"
            ]),
            ("hauler_indoor", "Hauler Indoor", [
                "Hauler Indoor", "Hauler_Indoor", "Hauler In",
                "HAULER Indoor", "HAULER", "Hauler", "운송사실내"
            ]),
        ...
        site_locations = [
            ("mir", "MIR Site", [
                "MIR", "MIR Site", "MIR_Site", "MIR사이트"
            ]),
            ("shu", "SHU Site", [
                "SHU", "SHU Site", "SHU_Site", "SHU사이트"
            ]),
            ("agi", "AGI Site", [
                "AGI", "AGI Site", "AGI_Site", "AGI사이트"
            ]),
            ("das", "DAS Site", [
                "DAS", "DAS Site", "DAS_Site", "DAS사이트"
            ]),
            ("shifting", "Shifting", [
                "Shifting", "SHIFTING", "Shift", "이동"
            ]),
        ]
        ...
        self.register(HeaderDefinition(
            ...
            aliases=[
                "Description", "Desc", "DESC", "Detail", "Details",
                "Name", "Item Name", "Item Description", "설명", "상세",
                "Description/명칭"
            ],
        ...
        quantity_fields = [
            ("quantity", "Quantity", [
                "QTY", "Qty", "Quantity", "Q'ty", "Qty.", "수량",
                "QUANTITY", "Amount", "Count"
            ]),
            ("sqm", "Square Meters", [
                "SQM", "sqm", "Square Meters", "㎡", "면적",
                "Square_Meters", "SQ M", "SQ.M"
            ]),
            ("weight", "Weight", [
                "Weight", "WT", "Wt", "무게", "중량", "WEIGHT",
                "Weight(kg)", "Weight (kg)"
            ]),
            ("volume", "Volume", [
                "Volume", "Vol", "부피", "VOLUME", "Vol.", "CBM",
                "Volume(m3)", "Volume (m3)"
            ]),
        ]
        ...
        status_fields = [
            ("status_warehouse", "Warehouse Status", [
                "Status_WAREHOUSE", "Status WAREHOUSE", "Warehouse Status",
                "WH Status", "창고상태", "Status-WH"
            ]),
            ("status_site", "Site Status", [
                "Status_SITE", "Status SITE", "Site Status",
                "사이트상태", "Status-SITE"
            ]),
            ...
            ("status_location", "Current Location", [
                "Status_Location", "Location", "Current Location",
                "위치", "현재위치", "Status-Location"
            ]),
            ("status_location_date", "Location Date", [
                "Status_Location_Date", "Location Date", "위치일자",
                "Status Location Date"
            ]),
            ("status_storage", "Storage Status", [
                "Status_Storage", "Storage Status", "Storage",
                "저장상태", "보관상태"
            ]),
            ("stack_status", "Stack Status", [
                "Stack_Status", "Stack Status", "Stacking",
                "적재상태", "Stack-Status"
            ]),
        ]
        ...
        handling_fields = [
            ("wh_handling", "Warehouse Handling", [
                "wh handling", "WH Handling", "Warehouse Handling",
                "wh_handling", "창고핸들링", "WH-Handling"
            ]),
            ("site_handling", "Site Handling", [
                "site handling", "site  handling", "Site Handling",
                "site_handling", "사이트핸들링", "Site-Handling"
            ]),
            ("total_handling", "Total Handling", [
                "total handling", "Total Handling", "total_handling",
                "전체핸들링", "Total-Handling"
            ]),
            ("final_handling", "Final Handling", [
                "final handling", "Final Handling", "final_handling",
                "최종핸들링", "Final-Handling"
            ]),
            ("minus", "Minus/Deduction", [
                "minus", "Minus", "MINUS", "차감", "-"
            ]),
        ]
    ...
    def get_by_category(self, category: HeaderCategory) -> List[HeaderDefinition]:
        ...
        """
        return [defn for defn in self.definitions.values() 
    ...
    def get_required_headers(self) -> List[str]:
        ...
        """
        return [key for key, defn in self.definitions.items() 
                if defn.required]
