...
class HeaderRegistry:
    ...
    def _initialize_definitions(self):
        ...
        # ===== VENDOR HEADER =====
        # Vendor name (e.g., SCT, HITACHI, SIEMENS, PPL, MOSB)
        # This is different from Source_Vendor (which tracks data source: HITACHI/SIEMENS)
        self.register(
            HeaderDefinition(
                semantic_key="vendor",
                category=HeaderCategory.METADATA,
                aliases=["Vendor", "vendor", "VENDOR", "Vendor Name", "vendor_name"],
                description="Vendor name for cargo/package (e.g., SCT, HITACHI, SIEMENS, PPL, MOSB)",
                required=False,
            )
        )
