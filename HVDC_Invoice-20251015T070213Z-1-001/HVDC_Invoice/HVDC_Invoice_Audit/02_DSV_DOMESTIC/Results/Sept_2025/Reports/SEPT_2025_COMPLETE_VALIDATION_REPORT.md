...
| **DN PDF 파싱 성공률** | 36/36 (100.0%) |
| **Invoice-DN 매칭률** | 70.5% (31/44) |
...
1. **DN 미발견**: 13건 - Supporting Documents 보완 필요
2. **매칭 실패**: 9건 - 추가 정규화 규칙 필요
3. **PDF 파싱 실패**: 0건 - OCR 품질 개선 필요
...
**Report Generated**: 2025-10-14 20:29:24
