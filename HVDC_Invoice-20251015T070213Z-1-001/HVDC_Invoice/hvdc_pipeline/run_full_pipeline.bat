...
echo 파일 복사 중...
copy "data\processed\synced\HVDC WAREHOUSE_HITACHI(HE).synced_v2.9.4.xlsx" "data\processed\synced\synced_for_stage2.xlsx" >nul
echo 파일 복사 완료! (Stage 2 입력 파일 준비)
echo.

echo Stage 2-3: Derived Columns & Report Generation 실행 중...
...
echo Stage 4: Anomaly Detection 실행 중... (이상치 색상 적용 포함)
