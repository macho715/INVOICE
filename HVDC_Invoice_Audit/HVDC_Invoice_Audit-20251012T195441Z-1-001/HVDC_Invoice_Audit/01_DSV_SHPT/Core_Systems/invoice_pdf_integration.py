...
# PDF 통합 모듈 임포트 - 00_Shared/pdf_integration 사용
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "00_Shared"))

try:
    # 모든 모듈을 00_Shared/pdf_integration에서 임포트
    ...
    logging.info("PDF Integration modules loaded successfully from 00_Shared/pdf_integration")
