...
| 2 | **SYSTEM_ARCHITECTURE.md** | `Documentation/01_ARCHITECTURE/` | 개발자, 아키텍트 | 시스템 구조, 컴포넌트 |
| 3 | **SYSTEM_ARCHITECTURE_DIAGRAM.md** | `Documentation/01_ARCHITECTURE/` | 모든 사용자 | 시각적 아키텍처 다이어그램 📊 |
| 4 | **CORE_LOGIC.md** | `Documentation/01_ARCHITECTURE/` | 개발자 | 핵심 알고리즘 상세 |
| 5 | **PATCH_HISTORY.md** | `Documentation/03_PATCH_HISTORY/` | 모든 사용자 | 개발 이력, 개선 내역 |
| 6 | **USER_GUIDE.md** | `Documentation/02_GUIDES/` | 운영자, 감사자 | 실행 방법, 결과 해석 |
| 7 | **DEVELOPMENT_GUIDE.md** | `Documentation/02_GUIDES/` | 개발자 | 개발 환경, 코딩 규약 |
| 8 | **API_REFERENCE.md** | `Documentation/02_GUIDES/` | 개발자 | 함수 시그니처, 환경변수 |
